    ...
    static private func initialize() {
        dispatch_once(&once) {
            ...
            Decoders.addDecoder(clazz: InlineResponse200.self) { (source: AnyObject) -> InlineResponse200 in
                ...
                instance.statuscode = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["statuscode"])
                instance.transactionType = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["transaction_type"])
                return instance
            }
        }
    }
