...
public class PesamoniAPI {
    public static var basePath = "https://pesamoni.com/api/live/v1"
...
public class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:AnyObject]?, isBody: Bool, headers: [String:String] = [:]) {
        ...
        addHeaders(PesamoniAPI.customHeaders)
    }
    ...
    public func addCredential() -> Self {
        self.credential = PesamoniAPI.credential
        return self
    }
}
